# We have chosed eleven labs for tts because  of its high Quality🗣️,Emotion🎭,Speed⚡
from elevenlabs import generate, play, save, set_api_key, voices
import tempfile
import os

#first we will set the api key
...
"""
speak(
    text="Hi there! I'm your learning buddy. Let's explore something fun together!",
    language="en",
    age_group="child"
)
"""